...
- [五关扩展需求](docs/five_level_expansion_requirements.md)：五个正式关的设计约束、组件、日志与验收标准。本期只收录需求，尚未按该文档重做关卡。
- [实验数据字典](docs/experiment_data_dictionary.md)：原始 CSV、派生分析与保存路径。
...
场景与 UI 基于 Sprout Lands 风格素材；角色动画来自 Jungle Monkey Platformer。详见 `assets/`。
